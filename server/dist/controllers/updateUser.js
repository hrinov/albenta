...
const updateUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const avatar = req === null || req === void 0 ? void 0 : req.uploadedFilePath;
    ...
    //update user
    try {
        const data = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, req.user), (name ? { name } : {})), (email
            ? {
                email: email,
